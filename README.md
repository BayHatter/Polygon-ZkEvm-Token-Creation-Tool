# Polygon ZkEvm Token Creation Tool

A simple frontend tool to create tokens on the Polygon ZkEvm network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Polygon-ZkEvm-Token-Creation-Tool.git
- And press deploy
- Congrats your Polygon ZkEvm Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Polygon-ZkEvm-Token-Creation-Tool
- Upload into your Github repo.
- Edit the file public/config.json and insert your Polygon ZkEvm wallet address for receiving fees. Also set fee in ETH that you want to charge
